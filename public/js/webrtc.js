...
class Webrtc extends EventTarget {
    ...
    // Get local stream
    // async getLocalStream(audioConstraints, videoConstraints) {
    //     try {
    ...
    //     }
    // }
    getLocalStream(videoConstraints, audioConstraints) {
    ...
    // async getLocalStream(videoConstraints, audioConstraints) {
    //     try {
